    ...
    <div className='w-full h-screen bg-zinc-100 p-20 flex gap-5 font-["Founders Grotesk X-Condensed"]'>
      <div className="w-1/2  h-full flex flex-col justify-between">
        <div className="heading">
          <h1
            className="text-[8vw]
            font-bold uppercase leading-none -mb-5 tracking-tighter"
          >
            eye-
          </h1>
          <h1
      ...
      <div className="w-1/2">
        <h1
          className="text-[6vw]
            font-semibold uppercase leading-none -mb-8 tracking-tighter"
        >
          presentations
        </h1>
        <div className="detailsContainer mt-16">
          <div className="Details pt-6">
            {["S:","Instagram","Behance", "Facebook", "LinkedIn"].map((items, index) => (
              <a
                key={index}
                className={"font-NeueMontreal block text-xl font-light underline"}
              >
                {items}
              </a>
            ))}
          </div>
          <div className="Details pt-6 mt-9">
            {["L:","202-1965 W 4th Ave","Vancouver,Canada","_", "30-Chukarina St", "Lviv,Ukraine"].map((items, index) => (
              <a
                key={index}
                className={"font-NeueMontreal block text-xl font-light underline"}
              >
          ...
          <div className="Details pt-6 mt-9">
            {["E:","hello@ochi.design"].map((items, index) => (
              <a
                key={index}
                className={"font-NeueMontreal block text-xl font-light underline"}
              >
